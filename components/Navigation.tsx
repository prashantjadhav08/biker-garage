...
export default function Navigation({ onLogout }: NavigationProps) {
  ...
  return (
    <nav className="bg-primary dark:bg-slate-950 text-white sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            {role === 'staff' && (
              <span className="bg-accent text-white text-xs px-2 py-1 rounded">Staff</span>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="p-2 text-slate-300 hover:text-white hover:bg-secondary rounded-lg transition-colors cursor-pointer"
